"""Compose distance-varied pieces with the ANN method (Algorithm B) of Tran-Lee-Jung
(2024) and render each as a real-geomungo mp3 excerpt for the web page.

Algorithm B (ANN) is run for d1, d3, d2 -> 3 clips: web/audio/compB_d{1,3,2}.mp3.
"""
import os, sys
